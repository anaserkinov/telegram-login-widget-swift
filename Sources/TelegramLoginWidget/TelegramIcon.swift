...
public struct TelegramIcon: Shape {
    ...
    public func path(in rect: CGRect) -> Path {
        ...
        path.addCurve(to: pt(d.x + 6.2, d.y + 1.43),
        ...
        path.addCurve(to: pt(e.x - 25.04, e.y + 23.84),
        ...
        path.addCurve(to: pt(f.x - 0.24, f.y + 7.63),
        ...
        path.addCurve(to: pt(g.x + 24.08, g.y + 16.69),
        ...
        path.addCurve(to: pt(h.x + 16.45, h.y - 2.15),
